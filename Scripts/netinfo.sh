...
if [ "${RESULT:-null}" = null ]; then
  ...
  echo " (*) Firewall en ejecución (sudo ufw status verbose)"
fi
echo "----------------------------" 
PS3="Seleccione una opcion: "
options=("iptraf-ng" "netstat y usuarios" "ss -tup (*)" "tcptrack" "netwatch" "trafshow" "nethogs" "nmap" "wireshark" "Mas Opciones..." "Salir")
